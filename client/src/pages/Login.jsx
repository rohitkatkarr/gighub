...
const Login = () => {
    ...
    const onSubmitHandler = async (e)=>{
        try{
            e.preventDefault(); // Prevents the browser from reloading the whole page when  button clicked
                ...
                <form onSubmit={onSubmitHandler}>
                    ...
                    {state === 'Sign Up' && (
                        <div className='mb-4 flex items-center gap-3 w-full px-5 py-2.5 rounded-full bg-[#333A5C]'>
                            <img className='w-5 h-5' src={assets.person_icon} alt="name" />
                            <input 
                    ...
                    <div className='mb-4 flex items-center gap-3 w-full px-5 py-2.5 rounded-full bg-[#333A5C]'>
                        <img className='w-5 h-5' src={assets.mail_icon} alt="email" />
                        <input
                    ...
                    <div className='mb-4 flex items-center gap-3 w-full px-5 py-2.5 rounded-full bg-[#333A5C]'>
                        <img className='w-5 h-5' src={assets.lock_icon} alt="password" />
                        <input
